...
class BarcodeScannerViewController: UIViewController {
    ...
    fileprivate lazy var buttonBgColor: UIColor = {
        var hex = (config.strings["btnColor"] ?? "#57D2C8FF")
        var red:   CGFloat = 87 / 255
        var green: CGFloat = 210 / 255
    ...
    fileprivate lazy var inputButton: UIButton = {
        ...
        inputButton.backgroundColor = buttonBgColor
    ...
    fileprivate lazy var openButton: UIButton = {
        ...
        openButton.backgroundColor = buttonBgColor
